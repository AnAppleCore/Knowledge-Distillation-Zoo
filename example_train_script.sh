...
# DML
# CUDA_VISIBLE_DEVICES=0,1,2,3 python -u train_dml.py \
#                            --save_root "./results/dml/" \
#                            --img_root "/home/hongwei/MOSE/data" \
#                            --net1_init "./results/base/base-c10-r110/initial_r20.pth.tar" \
